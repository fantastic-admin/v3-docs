import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.e8ba32c2.js";const p="/v3-docs/module1.gif",o="/v3-docs/module2.gif",g=JSON.parse('{"title":"标准模块","description":"","frontmatter":{},"headers":[],"relativePath":"guide/plop-module.md","filePath":"guide/plop-module.md"}'),e={name:"guide/plop-module.md"},t=l(`<h1 id="标准模块" tabindex="-1">标准模块 <sup class="pro-badge"></sup> <a class="header-anchor" href="#标准模块" aria-label="Permalink to &quot;标准模块 &lt;sup class=&quot;pro-badge&quot; /&gt;&quot;">​</a></h1><p>在《<a href="./plop.html#module">代码文件自动生成 - module</a>》里介绍了如何快速生成一个标准模块，这个标准模块是一个最基础的 CURD 模块，它包含列表页和编辑页，同时提供了搜索和删除的功能，并且同时也可以生成对应的 mock 文件，在这基础上可以更方便的进行业务扩展。</p><p>下面我就实际操作一遍，并介绍一下这个标准模块有哪些特性。</p><h1 id="用法说明" tabindex="-1">用法说明 <a class="header-anchor" href="#用法说明" aria-label="Permalink to &quot;用法说明&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">? 请选择需要创建的模式： module - 创建标准模块（包含列表页&amp;详情页）</span></span>
